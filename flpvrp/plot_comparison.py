"""
Visualization utilities for comparing FLP-VRP and NEO-DS solutions.
Creates 2x2 panel plots showing location-allocation decisions and vehicle routes
for both methods with control on all styling and tex figures.
"""
...
DIR_NEO = Path("NEO-LRP/neo-lrp/output/P_prodhon/deepsets_vroom_cost_over_fi_110000_plots")
RUN_INDEX = 1
INSTANCES = [
    "coord20-5-1",
    "coord20-5-1b",
