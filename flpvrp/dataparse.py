"""
Data parsing utilities for CLRP instances.
Reads benchmark data files, extracts customer and depot coordinates, demands, capacities,
and computes distance matrices with normalization.
"""
