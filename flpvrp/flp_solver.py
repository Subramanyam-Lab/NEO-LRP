"""
Capaciated Facility Location Problem (CFLP) solver using OR-Tools SCIP.
Assigns customers to depots by minimizing facility opening costs and assignment distances.
Outputs opened facilities, customer assignments, and solution costs.
"""
...
class createFlp():
    ...
    def flp(self):
        ...
        # Objective: minimize facility opening + assignment costs
