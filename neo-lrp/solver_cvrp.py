...
class dataCvrp ():
    ...
    # def solve_demo(self, data, cust, F=1000, time_resolution=3600, solver_name_input="CPLEX", solver_path="/storage/icds/RISE/sw8/cplex/22.1.1/cplex/lib/x86-64_linux/static_pic/libcplex.a"):
