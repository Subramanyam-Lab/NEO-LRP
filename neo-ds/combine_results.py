...
Usage:
    python combine_results.py --dataset S_schneider --normalization cost_over_fi --N 110000 --solver vroom --instances_file configs/schneider_instances.txt --delete_temp
"""
...
def main():
    ...
    excel_temp_dir = os.path.join(
        ...
        f"{args.solver}_{args.normalization}_{args.N}_excel_temp"
    )
